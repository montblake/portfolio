...
def send_resume(recipient_name, recipient_addr):
    ...
    with app.open_resource("static/resources/blake_montgomery_resume_021422.pdf") as bm_resume:
        msg.attach("static/resources/blake_montgomery_resume_021422.pdf", "text/pdf", bm_resume.read())
